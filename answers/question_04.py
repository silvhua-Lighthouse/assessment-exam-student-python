"""
 ...
 - Write a query to get the difference (salary_span) between min and max salary 
  for each job ID excluding programmer (job_id = 9) and sort it, 
 starting with the highest salary_span.
